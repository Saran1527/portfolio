...
const ContactSection: React.FC = () => {
  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "saranraj1552003@gmail.com",
      link: "mailto:saranraj1552003@gmail.com",
    },
    {
      icon: <Phone className="h-6 w-6 text-blue-600 dark:text-blue-400" />,
      title: "Phone",
      value: "+91 7010145439",
      link: "tel:+91 7010145439",
    },
    {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      href: "https://github.com/Saran1527",
      icon: (
        <svg
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/saranraj-s-368674224/",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
